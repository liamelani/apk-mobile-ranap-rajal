...
class TambahDataPasienRawatJalanScreen extends StatefulWidget {
  @override
  _TambahDataPasienRawatJalanScreenState createState() => _TambahDataPasienRawatJalanScreenState();
}

class _TambahDataPasienRawatJalanScreenState extends State<TambahDataPasienRawatJalanScreen> {
  ...
  Future<void> tambahDataPasien() async {
    if (_formKey.currentState!.validate()) {
      final Uri uri = Uri.parse('http://192.168.21.114/medical/create_pasien_rawat_jalan.php');
      ...
      if (response.statusCode == 200) {
        // Data berhasil disimpan, navigasi ke tampilan data pasien rawat jalan
        Navigator.of(context).pushReplacement(
          MaterialPageRoute(
            builder: (context) => DataPasienRawatJalanScreen(),
          ),
        );
      } else {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Tambah Data Pasien Rawat Jalan'),
      ),
      body: Padding(
